...
**Refreshed 2026-05-28.** A paste-friendly snapshot of Customer.io's design spec — voice rules, refinement levers, anti-patterns, governance, and per-component guidelines — consolidated into one file for tools that can't read source files directly.
